...
export type Database = {
  public: {
    Tables: {
      ...
      students: {
        Row: { id: string; section_id: string; full_name: string; created_at: string }
        Insert: { id: string; section_id: string; full_name: string; created_at?: string }
        Update: { id?: string; section_id?: string; full_name?: string; created_at?: string }
        Relationships: []
      }
      learn_progress: {
