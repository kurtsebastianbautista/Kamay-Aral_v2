        ...
        {filtered.map((student) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-indigo-100 dark:bg-indigo-950 text-sm font-bold text-indigo-600 dark:text-indigo-300">
